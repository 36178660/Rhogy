...
<div class="jumbotron">
<h3><span style="color:red"> Selecting the highest purchase amount with their ID, for only those <span style="color:blue"> Salesmen </span>whose ID is within the range 5003 and 5008.</span> </h3>
</div>
...
$sql="SELECT salesman_id,MAX(purch_amt) as max FROM orders GROUP BY salesman_id HAVING salesman_id BETWEEN 5003 AND 5008";
$sql_run=mysqli_query($con,$sql);
while($rows=mysqli_fetch_assoc($sql_run))
{
echo'
<tr>
<td>'.$rows['salesman_id'].'</td>
<td>'.$rows['max'].'</td>
