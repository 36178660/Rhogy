...
<div>
    ...
    <div class="col-sm-2 sidenav">
    <div class="well">
      <p> <a class="btn btn-success" href="Sum.php">customer notifications</a></p>
      </div>
      <div class="well">
        <p> <a class="btn btn-primary" href="more.php">More Customer aggregate functions</a></p>
      </div>
      <div class="well">
        <p> <a class="btn btn-success" href="count.php">count</a></p>
      </div>
