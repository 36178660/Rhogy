...
<div class="jumbotron">
<h3><span style="color:red">selecting some fields that match when the purchase amount was greater than 2000</span> </h3>
</div>
...
$sql="SELECT customer_id,MAX(purch_amt) as max FROM orders WHERE customer_id BETWEEN 3002 and 3007 GROUP BY customer_id HAVING MAX(purch_amt)>1000";
