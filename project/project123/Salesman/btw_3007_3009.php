...
<div class="jumbotron">
<h3><span style="color:red"> Selecting the highest purchase amount with their ID, for only those customers whose ID is within the range 3002 and 3007.</span> </h3>
</div>
...
$sql="SELECT customer_id,MAX(purch_amt) as max FROM orders WHERE customer_id BETWEEN 3002 and 3007 GROUP BY customer_id";
