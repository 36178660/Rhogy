...
<div class="jumbotron" style="box-shadow:0px 8px 8px 2px rgba(0,0,0,0.6)">
    ...
    <p style="float:left; margin-left:50px"> <a class="btn btn-success" href="AVG.php">Average Purch_amt</a></p>
...
$sql="SELECT AVG(purch_amt) as 'average' FROM orders";
$sql_run=mysqli_query($con,$sql);
$rows=mysqli_fetch_assoc($sql_run);
echo" <h1><b><span>Purchase_Amount_Average: </span></b></h1>".$rows['average'];
