...
<div class="jumbotron" style="box-shadow:0px 8px 8px 2px rgba(0,0,0,0.6)">
    ...
    <p style="float:right; margin-left:40px"> <a class="btn btn-success" href="purch_amt.php">purch_sum</a></p>
    <p style="float:left; margin-left:50px"> <a class="btn btn-success" href="AVG.php">Average</a></p>
