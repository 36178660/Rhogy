...
<div class="jumbotron" style="box-shadow:0px 8px 8px 2px rgba(0,0,0,0.6)">
    ...
    <div class="container">
<div class="jumbotron"  style="box-shadow:2px 6px 6px 2px rgba(1,1,1,0.6)">
...
<div class="container">
<div class="jumbotron">
<h4>Highest purchase amount with their ID and order date, for those customers who have a higher purchase amount in a day is within the range 2000 and 6000.</h4>
</div>
</div>
<div class="container">
...
$sql="SELECT customer_id,ord_date,MAX(purch_amt) as max FROM orders GROUP BY customer_id,ord_date HAVING MAX(purch_amt) BETWEEN 2000 AND 6000";
